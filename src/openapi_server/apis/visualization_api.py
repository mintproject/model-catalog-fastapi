...
@cache(namespace="Visualization", expire=1800)
...
async def visualizations_id_delete(
    id: str = Path( description="The ID of the Visualization to be retrieved"),
    ...
    await FastAPICache.clear(namespace="Visualization")
