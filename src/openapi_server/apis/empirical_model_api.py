...
@cache(namespace="EmpiricalModel", expire=1800)
...
async def empiricalmodels_id_delete(
    id: str = Path( description="The ID of the EmpiricalModel to be retrieved"),
    ...
    await FastAPICache.clear(namespace="EmpiricalModel")
