...
class TapisApp(BaseModel):
    ...
    sharedAppCtx: str | None = Field(None, min_length=1, max_length=60, description="Shared application context")
    isPublic: bool | None = Field(None, description="Whether the application is public")
    sharedWithUsers: List[str] | None = Field(default_factory=list, description="List of users the application is shared with")
    description: str | None = Field(None, max_length=2048, description="Application description")
    owner: str | None = Field(None, min_length=1, max_length=60, description="Application owner")
    enabled: bool | None = Field(None, description="Whether the application is enabled")
    versionEnabled: bool | None = Field(None, description="Whether this version is enabled")
    locked: bool | None = Field(None, description="Whether the application is locked")
    runtime: str | None = Field(None, description="Runtime environment (SINGULARITY, DOCKER, ZIP)")
    runtimeVersion: str | None = Field(None, description="Runtime version")
    runtimeOptions: List[str] | None = Field(None, description="Runtime options")
    containerImage: str | None = Field(None, description="Container image for the application")
    jobType: str | None = Field(None, description="Job type (BATCH, FORK)")
    maxJobs: int | None = Field(None, description="Maximum number of concurrent jobs")
    maxJobsPerUser: int | None = Field(None, description="Maximum number of concurrent jobs per user")
    strictFileInputs: bool | None = Field(None, description="Whether file inputs are strictly enforced")
    jobAttributes: JobAttributes | None = Field(None, description="Job attributes")
    tags: List[str] | None = Field(None, description="Application tags")
    notes: Dict[str, Any] | None = Field(None, description="Application notes")
    uuid: UUID | None = Field(None, description="Application UUID")
