...
from openapi_server.models.union_float_int import UnionFloatInit

from openapi_server.models.union_float_str_bool_init_none import UnionFloatStrBoolIntNone  # noqa: F401
...
class Parameter(BaseModel):
    ...
    has_maximum_accepted_value: Optional[List[UnionFloatStrBoolIntNone]] = Field(alias="hasMaximumAcceptedValue", default=None)
    ...
    has_fixed_value: Optional[List[UnionFloatStrBoolIntNone]] = Field(alias="hasFixedValue", default=None)
    ...
    has_step_size: Optional[List[UnionFloatInit]] = Field(alias="hasStepSize", default=None)
